...
public class DiscountTest {
    ...
    @Test
    public void testApplyDiscountLogic_whenProductNotInBasket_thenNoDiscountApplied() {
        // Arrange
    ...
    @Test
    public void testApplyDiscountLogic_whenProductInBasket_thenPriceAndAmountUpdated() {
        // Arrange
        PrecentageDiscount discount = new PrecentageDiscount(new Date(), 10, 1);
    ...
    @Test
    public void testApplyDiscountLogic_whenMultipleProductsInBasket_thenDiscountAppliedToMostExpensive() {
        // Arrange
        PrecentageDiscount discount = new PrecentageDiscount(new Date(), 10, 1);
    ...
    @Test
    public void testApplyDiscountLogic_whenDifferentProductInBasket_thenNoDiscountApplied() {
        // Arrange
        PrecentageDiscount discount = new PrecentageDiscount(new Date(), 10, 1);
        when(_basketMock.getProductCount(1)).thenReturn(0);
    ...
    @Test
    public void testApplyDiscountLogic_whenMultipleProductsInBasket_thenDiscountAppliedToCorrectProduct() {
        // Arrange
        PrecentageDiscount discount = new PrecentageDiscount(new Date(), 10, 1);
        when(_basketMock.getProductCount(1)).thenReturn(1);
        when(_basketMock.getProductCount(2)).thenReturn(1);
